...
import { z } from 'zod';
import { Save, Building2, Mail, Phone, MapPin, Globe, Tag, CreditCard, Calendar, FileText } from 'lucide-react';
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                disabled
                className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg bg-gray-50 cursor-not-allowed capitalize"
              />
            </div>
          </div>
        ...
        <div className="pb-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <div className="text-2xl font-bold text-gray-900">{settings._count.products || 0}</div>
            </div>
            <div className="bg-gray-50 rounded-lg p-4">
              <div className="text-sm text-gray-500">Orders</div>
              <div className="text-2xl font-bold text-gray-900">{settings._count.orders || 0}</div>
            </div>
            <div className="bg-gray-50 rounded-lg p-4">
              <div className="text-sm text-gray-500">Customers</div>
              <div className="text-2xl font-bold text-gray-900">{settings._count.customers || 0}</div>
            </div>
          </div>
        </div>
      )}
