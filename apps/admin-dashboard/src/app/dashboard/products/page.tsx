          ...
          <PermissionGuard permission={Permission.PRODUCTS_CREATE}>
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3">
              <Link
                ...
                className="inline-flex items-center justify-center px-4 py-2 bg-blue-600 dark:bg-blue-500 text-white rounded-lg hover:bg-blue-700 dark:hover:bg-blue-600 transition text-sm sm:text-base"
              >
                <Plus className="w-5 h-5 mr-2" />
