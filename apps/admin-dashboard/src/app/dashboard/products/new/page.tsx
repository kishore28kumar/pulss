...
import { ArrowLeft, Loader2, Store, Upload, ChevronDown, ChevronUp } from 'lucide-react';
                       ...
                       <div className="flex flex-wrap gap-4">
                         <label className="flex items-center space-x-2 cursor-pointer">
                           <input
                             ...
                             checked={!watch('isFeatured') && !watch('isSponsored')}
                             onChange={() => {
                               setValue('isFeatured', false);
                               setValue('isSponsored', false);
                             }}
                           />
                         ...
                         <label className="flex items-center space-x-2 cursor-pointer">
                           <input
                             ...
                             checked={watch('isSponsored') === true}
                             onChange={() => {
                               setValue('isFeatured', false);
                               setValue('isSponsored', true);
                             }}
                           />
