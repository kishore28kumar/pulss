        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Pharmacist Verified</h3>
              <p className="text-sm text-gray-600">All orders verified by our registered pharmacist before dispatch.</p>
            </div>
          </div>
        </div>
      </section>
